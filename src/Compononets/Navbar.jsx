...
const Navbar = () => {
    ...
    return (
        <div className="w-full md:w-4/5 z-[1] glass mx-auto px-5 py-5 flex flex-col rounded-b-3xl rounded-bl-3xl">
            {/* 1st navbar */}
            <div className=" text-white font-normal text-xs md:text-base  flex justify-center md:justify-end gap-5 md:gap-10 text-wrap flex-wrap">
                    ...
                    user ? (
                        user.displayName === "admin" ? (
                            ...
                            <div className="text-white font-normal text-xs md:text-base flex justify-center md:justify-end gap-5 md:gap-10">
                                ...
                                <Link to="/allorders" className="hover:text-[#53fff4] flex gap-2 items-center"><BsExclamationSquareFill />Orders</Link>
                                <Link to="/updatetrack"  className="hover:text-[#53fff4] flex gap-2 items-center"><BsExclamationSquareFill />Update Tracks</Link>
                    ...
                    <ul className="flex gap-2 lg:gap-10 pb-2 md:pb-0 ">
                        ...
                        <details className="dropdown">
                            ...
                            <ul tabIndex={0} className="dropdown-content menu bg-[#ffffffa0] z-[1] w-40 p-3 shadow flex flex-col gap-2 text-[#2C2C2C] font-bold text-base">
                                ...
                                <Link to="/track" className="hover:text-[#2C2C2C] "><a>Tracking</a></Link>
                            </ul>
                        </details>
